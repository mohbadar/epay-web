...
@Component({
    selector: 'app-list-receivable-document',
    templateUrl: './list-receivable-document.component.html',
    styleUrls: ['./list-receivable-document.component.scss']
})
export class ListReceivableDocumentComponent implements OnInit {
    ...
    renderData(tableOptions, filters) {
        ...
        this.spinner.show();
        this.receivableDocumentService.getMyDocumentsList(tableOptions, filters).subscribe((data: any) => {
            if (data == null) {
                this.rows = [];
                this.recordsTotal = 0;
            } else {
