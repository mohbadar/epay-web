...
import { ReceivableDocumentService } from '../receivable-document.service';
@Component({
    selector: 'app-list-receivable-execution',
    templateUrl: './list-receivable-execution.component.html',
    styleUrls: ['./list-receivable-execution.component.scss']
})
export class ListReceivableExecutionComponent implements OnInit {
    ...
    constructor(private cdref: ChangeDetectorRef, public translate: TranslateService,
        ...
        private sysRegService: SystemRegistryService, private receivableDocumentService: ReceivableDocumentService) { }
    ...
    renderData(tableOptions, filters) {
        ...
        this.spinner.show();
        this.receivableDocumentService.getMyExecutionsList(tableOptions, filters).subscribe((data: any) => {
            if (data == null) {
                this.rows = [];
                this.recordsTotal = 0;
            } else {
