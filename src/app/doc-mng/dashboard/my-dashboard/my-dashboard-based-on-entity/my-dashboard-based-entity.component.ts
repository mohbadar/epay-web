...
@Component({
  selector: 'app-my-dashboard-based-entity',
  templateUrl: './my-dashboard-based-entity.component.html',
  styleUrls: ['./my-dashboard-based-entity.component.scss'],
})

export class MyDashboadBasedEntityComponent {
  ...
  addForm: FormGroup;
	...
	RadioClicked(event) {
	  ...
	  loadDocumentByType(event){
		this.sprinner.show();
		this.docService.getMyDashboardDocumentCountbyEntityByTypeId(event.id).subscribe(res=>{
