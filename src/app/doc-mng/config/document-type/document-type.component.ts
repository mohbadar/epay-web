...
import { ViewDocumentTypeComponent } from './view-document-type/view-document-type.component';
...
export class DocumentTypeComponent implements OnInit {
  ...
  addNew(){
    const modalRef = this.modalService.open(CreateDocumentTypeComponent);
  ...
  editRecord(recordId) {
		...
		this.docMngService.getDocTyeById(recordId).subscribe(data => {
			...
			const modalRef = this.modalService.open(EditDocumentTypeComponent);
  ...
  deleteRecord(recordId)
	{
		// const modalRef = this.modalService.open(DeleteDocumentTypeComponent‌);
  ...
  viewRecord(recordId) {
		...
		this.docMngService.getDocTyeById(recordId).subscribe(data => {
			...
			const modalRef = this.modalService.open(ViewDocumentTypeComponent);
			modalRef.componentInstance.data = data;
			this.spinner.hide();
		}, error => {
			this.spinner.hide();
