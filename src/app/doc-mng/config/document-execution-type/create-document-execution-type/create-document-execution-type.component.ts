...
@Component({
  selector: 'app-create-document-execution-type',
  templateUrl: './create-document-execution-type.component.html',
  styleUrls: ['./create-document-execution-type.component.scss']
})
export class CreateDocumentExecutionTypeComponent implements OnInit {
